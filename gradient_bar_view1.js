...
var legend = function () {
    ...
    legend.append("stop").attr("offset", "0%").attr("stop-color", "#b92636").attr("stop-opacity", 1);
    legend.append("stop").attr("offset", "50%").attr("stop-color", "#FFFFFF").attr("stop-opacity", 1);

    legend.append("stop").attr("offset", "100%").attr("stop-color", "#3d428b").attr("stop-opacity", 1);
